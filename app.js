...
const {QualityExcelGenerate,QualityMonthlyReport} = require('./Utilis/QualityUtilis')
...
cron.schedule('10 11 1 * *', () => {
  console.log('Running the function at 10:00 AM on the first day of the month');
