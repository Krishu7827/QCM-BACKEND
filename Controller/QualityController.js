...
//n/a N/A
  let temp = productBarcode && productBarcode!='N/A' && productBarcode!='n/a' ? await queryAsync(`SELECT ProductBarCode FROM Quality WHERE ProductBarCode = '${productBarcode}' AND Status != 'Inprogress'`) : [];
