         ...
         <table class = "page-break" ${totalPage==page?'':'style="border-bottom:1px solid black;"'} >
            <thead>
                <tr>
                    ...
                    <th style="width:15%; font-size:15px; padding-top:3px; padding-bottom:3px;">Price ₹</th>
                    <th style="width:15%; font-size:15px; padding-top:3px; padding-bottom:3px;">Amount</th>
                </tr>
            </thead>
            <tbody>
            ${data.map((row, i) => {
                ...
                return `
                    <tr style="height:55px;">
                        ...
                        <td class="center-td" ${8-1 == i ? 'style="word-wrap: break-word; word-break: break-word; vertical-align: top;"' : 'style="border-bottom-style: hidden; word-wrap: break-word; word-break: break-word; vertical-align: top;"'}>${row.HSNCode || ""}</td>
                        <td class="center-td" ${8-1 == i ? 'style="word-wrap: break-word; word-break: break-word; vertical-align: top;"' : 'style="border-bottom-style: hidden; word-wrap: break-word; word-break: break-word; vertical-align: top;"'}>${formatNumberWithCommas((+row.Quantity).toFixed(2)) || ""}</td>
                        <td class="center-td" ${8-1 == i ? 'style="word-wrap: break-word; word-break: break-word; vertical-align: top;"' : 'style="border-bottom-style: hidden; word-wrap: break-word; word-break: break-word; vertical-align: top;"'}>${row.Unit || ""}</td>
                        <td class="center-td" ${8-1 == i ? 'style="word-wrap: break-word; word-break: break-word; vertical-align: top;"' : 'style="border-bottom-style: hidden; word-wrap: break-word; word-break: break-word; vertical-align: top;"'}>${formatNumberWithCommas((+row.Price_Rs).toFixed(2)) || ""}</td>
                        <td class="center-td" ${8-1 == i ? 'style="word-wrap: break-word; word-break: break-word; vertical-align: top;"' : 'style="border-bottom-style: hidden; word-wrap: break-word; word-break: break-word; vertical-align: top;"'}>${formatNumberWithCommas((+row.Amount).toFixed(2)) || ""}</td>
                    </tr>`;
            }).join(' ')
            }
            ...
            `<tr style="height:20px; ">
                       ...
                       <td style="border:0px solid black; font-weight:bold;" class="center-td" style = "text-align:center; font-weight:bold;" ></td>
                       <td  style="border:0px solid black; font-weight:bold;" class="center-td" ></td> <!-- Replace with actual Price -->
                       <td style="border:0px solid black; font-weight:bold; word-wrap: break-word; word-break: break-word;" class="center-td" style = "text-align:center; font-weight:bold;" >${formatNumberWithCommas(+totalQuantityPerPage.toFixed(2))} ${data[0].Unit}</td> <!-- Replace with actual Amount -->
                   </tr>`:`
                  <tr style="height:120px;">
