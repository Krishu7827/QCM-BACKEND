...
//       const loadImage = async (pdfDoc) => {
//           const imagePath = Path.resolve(__dirname, '../ExcelFile/image.png');
//           if (!fs.existsSync(imagePath)) {
//               throw new Error(`Image file not found: ${imagePath}`);
//           }
//           const imageBytes = fs.readFileSync(imagePath);
//           const embeddedImage = await pdfDoc.embedPng(imageBytes); // Change to embedJpg if using a JPG image
//           return embeddedImage;
//       };
  
//       const embeddedImage = await loadImage(pdfDoc);

//       /*********************** Usable Variable *******************************/
//       let padding = 10
//       let columnNames = ['Sr No.','Name','EmployeeID','Total Working Day','Total Completed Issue','Total Inprogress Issue']
//       // Draw the image on the page
//       const { width, height } = embeddedImage.scale(1); // Scale the image as needed
...
//       page.drawText('Quality Monthly Report', {
//         x: 300,
//         y:  700,
//           size: 17,
//           font:boldFont,
...
// Create the PDF
pdf.create(htmlContent, options).toFile('table.pdf', function(err, res) {
